...
class _CourseContentHolderState extends State<CourseContentHolder> {
  ...
  Future<Uint8List?> getData() {
    ...
    return widget.video!.video.getThumbnail(null);
  }
                      ...
                      children: [
                        FutureBuilder(
                            ...
                            builder: (context, snapshot) {
                              return CircleAvatar(
                                radius: 24,
                                backgroundImage: widget.video != null &&
                                        snapshot.hasData &&
                                        snapshot.data != null
                              ...
                              Wrap(
                                ...
                                children: [
                                  ...
                                  videoInfo(context,
                                      ...
                                      value:
                                          "${widget.video?.segmentNumber} of ${widget.video?.segmentTotal}"),
                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: Builder(builder: (context) {
                                  String? trans = widget.video?.transcript
                                      .where((e) =>
                                          _controller
                      ...
                      Wrap(
                        children: [
                          ...
                          IconButton(
                              ...
                              onPressed: () {
                                if (widget.video != null) {
                                  context.read<DashboardProvider>().addBookmark(
                                      context,
                                      feedID: widget.video!.id);
                                }
                              },
                              icon: SvgPicture.string(
                                (widget.video?.bookmark ?? false)
                                    ? """<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="black" stroke="black" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M5 21V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16l-5.918-3.805a2 2 0 0 0-2.164 0z"/></svg>"""
                                    : """<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="none" stroke="black" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M5 21V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16l-5.918-3.805a2 2 0 0 0-2.164 0z"/></svg>""",
